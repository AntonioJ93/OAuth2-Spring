package com.tutorial.autorizationserver.config;
...
/**
 * Endpoints http://localhost:9000/.well-known/oauth-authorization-server
 */
    ...
    public SecurityFilterChain webSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(authorize ->
                        authorize
                                .requestMatchers("/auth/**","/client/**", "/login").permitAll() //TODO: proteger /client/** solo permitir a admin
...
//    }
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> tokenCustomizer(){
        //agregar info al token claims !!!No poner infor sensible se puede leer
        return context -> {
